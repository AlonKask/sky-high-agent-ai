      ...
      <CardContent>
        ...
        <div className="rounded-md border overflow-x-auto">
          <Table className="w-full min-w-[800px] table-fixed">
            <TableHeader>
              <TableRow>
                <TableHead className="w-20 !px-4 !py-3 text-left font-medium">IATA Code</TableHead>
                <TableHead className="w-20 !px-4 !py-3 text-left font-medium">ICAO Code</TableHead>
                <TableHead className="w-64 !pl-8 !pr-4 !py-3 text-left font-medium">Name</TableHead>
                <TableHead className="w-28 !px-4 !py-3 text-left font-medium">Country</TableHead>
                <TableHead className="w-32 !px-4 !py-3 text-left font-medium">Alliance</TableHead>
                <TableHead className="w-16 !px-4 !py-3 text-center font-medium">RBDs</TableHead>
                <TableHead className="w-28 !px-4 !py-3 text-center font-medium">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {loading ? (
                Array.from({ length: 5 }).map((_, i) => (
                  <TableRow key={i}>
                    <TableCell className="w-20 !px-4 !py-4"><Skeleton className="h-4 w-12" /></TableCell>
                    <TableCell className="w-20 !px-4 !py-4"><Skeleton className="h-4 w-14" /></TableCell>
                    <TableCell className="w-64 !pl-8 !pr-4 !py-4"><Skeleton className="h-4 w-40" /></TableCell>
                    <TableCell className="w-28 !px-4 !py-4"><Skeleton className="h-4 w-20" /></TableCell>
                    <TableCell className="w-32 !px-4 !py-4"><Skeleton className="h-4 w-24" /></TableCell>
                    <TableCell className="w-16 !px-4 !py-4 text-center"><Skeleton className="h-4 w-10 mx-auto" /></TableCell>
                    <TableCell className="w-28 !px-4 !py-4 text-center"><Skeleton className="h-4 w-16 mx-auto" /></TableCell>
                  </TableRow>
                ))
                    ...
                    <Collapsible key={airline.id} open={isExpanded} onOpenChange={() => toggleAirlineExpansion(airline.id)}>
                        <CollapsibleTrigger asChild>
                          <TableRow className="cursor-pointer hover:bg-muted/50">
                            <TableCell className="w-20 !px-4 !py-4 font-mono font-semibold text-left">{airline.iata_code}</TableCell>
                            <TableCell className="w-20 !px-4 !py-4 font-mono text-left">{airline.icao_code || '-'}</TableCell>
                            <TableCell className="w-64 !pl-8 !pr-4 !py-4 text-left">
                            ...
                            <TableCell className="w-28 !px-4 !py-4 text-left">{airline.country || '-'}</TableCell>
                            <TableCell className="w-32 !px-4 !py-4 text-left">
                              {airline.alliance && (
                                <Badge variant="outline" className="text-xs whitespace-nowrap">{airline.alliance}</Badge>
                              )}
                            </TableCell>
                            <TableCell className="w-16 !px-4 !py-4 text-center">
                              <Badge variant="secondary" className="text-xs">
                                {airline.rbd_count || 0}
                              </Badge>
                            </TableCell>
                            <TableCell className="w-28 !px-4 !py-4 text-center">
