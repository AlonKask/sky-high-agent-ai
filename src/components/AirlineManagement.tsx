      ...
      <CardContent>
        ...
        <div className="rounded-md border overflow-x-auto">
          <Table className="w-full min-w-[800px] table-fixed">
            <TableHeader>
              <TableRow>
                <TableHead className="w-20 px-4 py-3 text-left">IATA Code</TableHead>
                <TableHead className="w-20 px-4 py-3 text-left">ICAO Code</TableHead>
                <TableHead className="w-64 pl-8 pr-4 py-3 text-left">Name</TableHead>
                <TableHead className="w-28 px-4 py-3 text-left">Country</TableHead>
                <TableHead className="w-32 px-4 py-3 text-left">Alliance</TableHead>
                <TableHead className="w-16 px-4 py-3 text-center">RBDs</TableHead>
                <TableHead className="w-28 px-4 py-3 text-center">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {loading ? (
