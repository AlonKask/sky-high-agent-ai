-- COMPREHENSIVE SECURITY FIX PLAN - CORRECTED
...
BEGIN
  ...
  INSERT INTO security_events (
    ...
    p_details || jsonb_build_object(
      ...
      'user_role', COALESCE((SELECT role FROM user_roles WHERE user_id = current_user_id), 'unknown')
    ),
    now(),
    inet_client_addr(),
...
-- 6. Update email_exchanges RLS for communication security
...
-- 7. Update quotes RLS for financial data security
...
-- 8. Create comprehensive security monitoring function
