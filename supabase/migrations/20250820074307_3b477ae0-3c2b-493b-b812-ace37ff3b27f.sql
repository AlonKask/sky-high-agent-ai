-- Drop function with CASCADE to remove dependencies first
DROP FUNCTION IF EXISTS public.check_advanced_rate_limit(text, text, integer, integer) CASCADE;
...
-- Create new consolidated, secure RLS policies for clients - users can ONLY access their own data
...
-- Clean up and strengthen quotes table RLS
...
-- Create secure quotes policies with financial data protection - users can ONLY access their own data
