-- STEP 1: CRITICAL SECURITY REMEDIATION (Fixed)
...
-- Add trigger for gmail credentials auditing (fixed syntax)
...
DROP POLICY IF EXISTS "Strict communication isolation" ON public.email_exchanges;
