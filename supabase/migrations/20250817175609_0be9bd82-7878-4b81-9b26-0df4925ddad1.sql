-- ========================================
-- CRITICAL SECURITY FIX: ENCRYPTION KEYS TABLE ABSOLUTE LOCKDOWN
-- ========================================
...
BEGIN
  ...
  INSERT INTO public.security_events (
    ...
    'encryption_infrastructure_breach_attempt',
    'critical',
    jsonb_build_object(
      'operation', TG_OP,
...
INSERT INTO public.security_events (
  ...
  'encryption_keys_security_hardening_complete',
  'critical',
  jsonb_build_object(
