-- Phase 5: Database Optimization - Add indexes for better performance
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_email_exchanges_user_created 
ON email_exchanges(user_id, created_at DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_email_exchanges_user_folder_date 
ON email_exchanges(user_id, folder_name, created_at DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_email_exchanges_message_user 
