-- Final Security Cleanup - Phase 4: Resolve all policy conflicts (Fixed)
...
DECLARE
  tbl_name text;
  sensitive_tables text[] := ARRAY['option_reviews', 'oauth_state_tokens', 'audit_logs'];
BEGIN
