...
-- Log the security hardening with a valid event type
INSERT INTO public.security_events (
  ...
  jsonb_build_object(
    ...
    'tables_affected', ARRAY['bookings', 'email_exchanges', 'requests'],
    'policies_removed', 'conflicting_emergency_access_policies',
    'security_improvement', 'eliminated_data_exposure_risks',
    'timestamp', now()
  )
);