-- Create secure RPC function to get request details with proper access control
...
BEGIN
  -- Get request details
  SELECT 
    r.id, r.user_id, r.assigned_to, r.client_id, r.origin, r.destination,
    r.departure_date, r.return_date, r.passengers_adults, r.passengers_children,
    r.passengers_infants, r.class_preference, r.trip_type, r.special_requirements,
  ...
  SELECT 
    ...
    request_record.origin,
    request_record.destination,
    request_record.departure_date,
    request_record.return_date,
    request_record.passengers_adults,
    request_record.passengers_children,
    request_record.passengers_infants,
    request_record.class_preference,
    request_record.trip_type,
