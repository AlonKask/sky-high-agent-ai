...
-- =============================================================================
-- FIX 4: SECURE EMAIL EXCHANGES - Consolidate overlapping policies into simple user access
-- =============================================================================
...
-- Log this security enhancement using valid event type
SELECT public.log_security_event(
  'system_maintenance',
  'critical',
  jsonb_build_object(
    'maintenance_type', 'rls_policy_consolidation',
