...
-- 1. First, drop and recreate the has_role function with correct parameter name
...
-- 3. Create table for user dashboard preferences (for 'user' role)
...
-- 4. Add status field to requests if it doesn't exist
DO $$ 
BEGIN
