-- Insert additional airport codes (batch 2)
...
('PAE', 'Paine Field', 'Everett', 'United States'),
...
('PIB', 'Hattiesburg–Laurel Regional Airport', 'Hattiesburg', 'United States'),
...
('RDM', 'Redmond Municipal Airport', 'Redmond', 'United States'),
...
('ROW', 'Lea County Regional Airport', 'Roswell', 'United States'),
...
('SPS', 'Sheppard Air Force Base', 'Wichita Falls', 'United States'),
...
('BUP', 'Beaumont Municipal Airport', 'Beaumont', 'United States'),
('CEC', 'Jack McNamara Field', 'Crescent City', 'United States'),
...
('CYS', 'Cheyenne Regional Airport', 'Cheyenne', 'United States'),
